...
Connecting to Azure Blob Storage can be similar to the example taken from MicrosoftLearning:

(this is a sample taken directly from https://github.com/MicrosoftLearning/AZ-204-DevelopingSolutionsforMicrosoftAzure/blob/master/Instructions/Labs/AZ-204_lab_03.md)
